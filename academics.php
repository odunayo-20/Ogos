                ...
                <div class="col-md-3 left-cards">
                    ...
                    <div class="card bg-warning mx-auto mb-3 mt-3 text-center " style="height: auto;">
                        ...
                        <div class="card-body mb-3">
                            <div class="card-text">
                                <a href="#" class="btn btn-light"> Admission Guildlines </a>
                                <a href="#" class="btn btn-light"> Fill Admission Form </a>
                                <a href="#" class="btn btn-light text-capitalise"> Download Admission Form </a>
                            </div>
                        </div>
                    ...
                    <div class="mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <!-- <div class="pic"> -->
                                    <div class="row">
                                        ...
                                        <img src="academics/22.jpg" alt="img" class="img-fluid d-block col-md-3 py-1">
                                        <img src="academics/23.jpg" alt="img" class="img-fluid d-block col-md-3 py-1">
                                        <img src="academics/24.jpg" alt="img" class="img-fluid d-block col-md-3 py-1">
                                        <img src="academics/25.jpg" alt="img" class="img-fluid d-block col-md-3 py-1">
                        ...
                        <div class="card mb-2" id="primary">
                            <div class="card-body">
                                ...
                                <div class="row py-2">
                                    <img src="academics/22.jpg" alt="img" class="img-fluid d-block py-1 col-md-3">
                                    <img src="academics/23.jpg" alt="img" class="img-fluid d-block py-1 col-md-3">
                                    <img src="academics/24.jpg" alt="img" class="img-fluid d-block py-1 col-md-3">
                                    <img src="academics/25.jpg" alt="img" class="img-fluid d-block py-1 col-md-3">
