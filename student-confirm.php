...
?>
            ...
            <div class="container">
                ...
                <div class="container ">
                        <h6 class="text-center"> STUDENT CONFIRMATION PAGE</h6>
                    </strong>
                </div>
            ...
            <div class="container mb-5">
                ...
                <p> I hereby, declearing that i <strong><?php echo $firstname.' '.$middlename.' '.$lastname; ?></strong> will obey the rules and regulations of the institution as a student and be fully responsible for violating the rules. </p>
                <p class="text-center"><a href="student-login.php">Login Here</a></p>
            </div>
            <!-- declearation -->
        </div>
