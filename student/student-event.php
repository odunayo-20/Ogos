              ...
              <div class="table-responsive">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <!-- <td><?php //echo $row['event_title']; 
                                ?></td> -->
                      <td><a href="student-event-details.php?id=<?php echo $row['id'] ?>"><?php echo $title; ?></a>
                      </td>
                      <?php
                      $img =  $row['event_img'];
                      $time = $row['event_time'];
                      ...
                      <td><?php echo $date; ?></td>
                      <td><?php echo $time; ?></td>
                      <td><a href="student-event-details.php?id=<?php echo $row['student_id']; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
</td>
                ...
                <ul class="pagination">
                  <?php if ($pagenumber > 1) { ?>
                    ...
                    <li class="page-item"> <a href="student-event.php?pageid=<?php echo $pagenumber - 1 ?>" class="page-link">Previous</a></li>
                  <?php } ?>
                  ...
                  for ($i = 1; $i <= $total; $i++) {
                    if ($pagenumber == $i) {
                  ?>
                      <li class="page-item active"> <a href="student-event.php?pageid=<?php echo $i ?>" class="page-link"><?php echo $i; ?></a></li>
                    <?php } else {
                    ?>
                      <li class="page-item"> <a href="student-event.php?pageid=<?php echo $i ?>" class="page-link"><?php echo $i; ?></a></li>
                  ...
                  <?php if ($pagenumber != $total) { ?>
                    ...
                    <li class="page-item"> <a href="student-event.php?pageid=<?php echo $pagenumber + 1; ?>" class="page-link">Next</a></li>
                  <?php } ?>
