    ...
    <section class="section">
        <div class="section-body">
            ...
            if (isset($_GET['pageid'])) {
              ...
              $sql = ("SELECT * FROM news WHERE status = 'published' order by id desc LIMIT $start, $limit");
            ...
            ?>
                                        ...
                                        <ul class="nav nav-pills">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#">All <span
                                                        class="badge badge-white"><?php echo $publishCount ?></span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                  ...
                  ?>
                                    ...
                                    <tr>
                                        ...
                                        <td> <img class="img-fluid rounded-circle"
                                                ...
                                                src="../<?php echo $img ?>" alt=""></td>
                                        <td><?php echo $row['date'] . '   ' . $row['time']; ?></td>

                                        <?php
                      $id_event = $row['id']; ?>
                                        <td><a href='student-news-details.php?id=<?php echo $id_event; ?>'><i
                  ...
                  ?>
                                ...
                                <ul class="pagination">
                                    ...
                                    <li class="page-item"> <a
                                            href="student-news.php?pageid=<?php echo $pagenumber - 1 ?>"
                  ...
                  for ($i = 1; $i <= $total; $i++) {
                    if ($pagenumber == $i) {
                  ?>
                                    <li class="page-item active"> <a href="student-news.php?pageid=<?php echo $i ?>"
                                            class="page-link"><?php echo $i; ?></a></li>
                                    <?php } else {
                    ?>
                                    <li class="page-item"> <a href="student-news.php?pageid=<?php echo $i ?>"
                                            class="page-link"><?php echo $i; ?></a></li>
