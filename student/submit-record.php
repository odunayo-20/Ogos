...
while($row = mysqli_fetch_assoc($test)){
  ...
  $student_name = $firstname . ' ' . $lastname;
            ...
            if (isset($_GET['pageid'])) {
              ...
              $sql = ("SELECT * FROM submit_assign WHERE class = '$class' AND student_name = '$student_name' order by id desc LIMIT $start, $limit");
            ...
            $query = "SELECT * FROM submit_assign WHERE class = '$class'";
