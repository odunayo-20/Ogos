                ...
                <div class="row">
                  ...
                  ?>
                    ...
                    <div class="col-md-3 col-sm-6 py-2 ">
                      <a href="<?php echo $img; ?>" class="profile"> <img class="img-fluid" src="<?php echo $img; ?>" alt="img" style="width:100%; height: 200px;">
                      </a>
                    </div>
                  <?php      }
                  ?>
                ...
                $result = mysqli_query($connection, $query);
                  ...
                  ?>
                    <div class="col-md-4 p-2">
                      ...
                      <a href="<?php echo $img; ?>"> <img class="img-fluid" style="height: 20rem; width:100%;" src="<?php echo $img; ?>" alt="img">
                      </a>
                    </div>
                  <?php      }
                  ?>
                ...
                <div class="row py-2">
                  ...
                  ?>
                    <div class="col-md-2 col-sm-12 p-2">
                      ...
                      <a href="<?php echo $img; ?>" class="profile"> <img class="img-fluid" src="<?php echo $img; ?>" alt="img" style="width: 100%;">
                      </a>
                    </div>
                  <?php      }
                  ?>
