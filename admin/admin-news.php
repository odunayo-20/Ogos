    ...
    <div class="section-body">
      ...
      <div class="row">
        <div class="col-md-12 my-3">
          <a href="admin-news-add.php" class="btn btn-primary" style="float: right;">Add News</a>
        </div>
        <div class="col-12">
        <?php 
...
<style>
  button,form,input{
    display: inline;
                      ...
                      <?php
                      $id_event = $row['id']; ?>
                      <td><a href='admin-news-check.php?publish=<?php echo $id_event; ?>'>Publish</a></td>
                      <td><a href='admin-news-check.php?draft=<?php echo $id_event; ?>'>Draft</a></td>
                      <td>
                        <a href="admin-news-details.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-warning" title="View more"><i class="fas fa-eye"></i></a>
                        <a href="admin-news-edit.php?id=<?php echo $row['id'];?>" class="btn btn-outline-primary" title="Edit"><i class="fas fa-pen"></i></a>
                        <a href="admin-news-delete.php?id=<?php echo $row['id'];?>" class="btn btn-outline-danger" title="delete" id="delete"><i class="fas fa-trash"></i></a>
                ...
                <ul class="pagination">
                  <?php if ($pagenumber > 1) { ?>
                    ...
                    <li class="page-item"> <a href="admin-news.php?pageid=<?php echo $pagenumber - 1 ?>" class="page-link">Previous</a></li>
                  <?php } ?>
                  ...
                  for ($i = 1; $i <= $total; $i++) {
                    if ($pagenumber == $i) {
                  ?>
                      <li class="page-item active"> <a href="admin-news.php?pageid=<?php echo $i ?>" class="page-link"><?php echo $i; ?></a></li>
                    <?php } else {
                    ?>
                      <li class="page-item"> <a href="admin-news.php?pageid=<?php echo $i ?>" class="page-link"><?php echo $i; ?></a></li>
                  ...
                  <?php if ($pagenumber != $total) { ?>
                    ...
                    <li class="page-item"> <a href="admin-news.php?pageid=<?php echo $pagenumber + 1; ?>" class="page-link">Next</a></li>
                  <?php } ?>
