...
<div class="main-content">
    ...
    <section class="section">
        <div class="section-body">
            ...
            $query = "SELECT * FROM staff WHERE staff_id = '{$idd}'";
            ...
            <div class="main-container">
                ...
                <form class="" action="admin-staff-edit-process.php" method="post" enctype="multipart/form-data">
                    <?php
                    ...
                    <section>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" class="form-control" placeholder="" name="serial"
                                        value="<?php echo $serial ?>" required=required />
                                </div>

                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" class="form-control" placeholder="" name="username"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="dob" type="date" class="form-control" placeholder=""
                                        required="required" value="<?php echo $dob ?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="state" type="text" class="form-control" placeholder=""
                                        required="required" value="<?php echo $state ?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="lga" type="text" class="form-control" placeholder=""
                                        required="required" value="<?php echo $lga ?>" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="town" type="text" class="form-control" placeholder=""
                                        required="required" value="<?php echo $town ?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" placeholder="@gmail.com" name="email" class="form-control"
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <select name="year_employed" id="" class="custom-select form-control">
                                        <option value="<?php echo $year_employed ?>"><?php echo $Year_employed ?>
                                        </option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <img src="../<?php echo $img ?>" alt="" class="img-fluid rounded-circle my-2"
                                    style="height:50px; width:50px;" id="showImage">
                                <br>
