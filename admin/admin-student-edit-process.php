...
if($img_name != ''){
    ...
    $query = "UPDATE student SET username = '$username', img = '$update_image', serial = '$serial1', firstname = '$firstname', middlename = '$middlename', lastname ='$lastname', gender = '$gender', dob = '$birth', state = '$state', town = '$town', lg = '$lga', email = '$email', phone = '$phone', location = '$address', class = '$class' WHERE student_id = '$id'";
